      ...
      <div className="flex-1 pr-16">
        <div className="container mx-auto px-6 py-8">
          ...
          <div className="flex justify-between items-center mb-8">
            <div>
              <h1 className="text-3xl font-bold text-text-dark mb-2">Schedule</h1>
              <p className="text-text-muted">Manage your appointments and availability</p>
            </div>
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="grid grid-cols-8 gap-px bg-gray-200 rounded-lg overflow-hidden">
                      {/* Time column header */}
                      <div className="bg-white p-3 font-medium text-center">Time</div>
                      ...
                      {timeSlots.map((time, timeIndex) => (
                        <React.Fragment key={timeIndex}>
                          ...
                          {getWeekDays(currentWeek).map((day, dayIndex) => {
                            ...
                            return (
                              <div key={dayIndex} className="bg-white p-1 min-h-[60px] relative">
                                {events.map((event) => (
                                  <div
                                    key={event.id}
                                    className={`p-2 rounded text-xs ${getTypeColor(event.type)} cursor-pointer hover:shadow-sm transition-shadow`}
                                  >
