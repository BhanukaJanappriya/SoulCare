...
import { Stethoscope, ArrowLeft } from "lucide-react"; // Using Stethoscope icon for Doctor

const DoctorRegister: React.FC = () => {
  // State management mirroring CounselorRegister.tsx
  ...
  // Submission logic mirroring CounselorRegister.tsx
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // The only change in logic: the API endpoint URL
      ...
      // You can uncomment the navigation or add a delay
        ...
        <Card className="healthcare-card">
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              {/* Form fields specific to the Doctor */}
