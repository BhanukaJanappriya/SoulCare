...
import {
  ...
  Star,
  CheckCircle2,
  CalendarDays, // Added to match the header icon of provider view
} from "lucide-react";
...
// --- Data Fetching & Mutation Functions (UNCHANGED) ---
...
// --- Rating Dialog Component (UNCHANGED) ---
...
const PatientAppointments: React.FC = () => {
  ...
  // --- Styling: Updated to match Provider View ---
  ...
  // --- Empty State Styled like Provider View ---
  const EmptyState = ({
    message,
    subMessage, // Added subMessage support
    icon: Icon,
  }: {
    message: string;
    subMessage?: string;
  ...
  return (
    <div className="p-6 md:p-8 mx-auto bg-background">
      {/* --- HEADER SECTION (MATCHING APPOINTMENTS.TSX) --- */}
      <Card className="mb-8 shadow-sm bg-card">
        <CardHeader>
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            ...
            {/* Original Book Button (Integrated into New Header) */}
            <Button
              asChild
      ...
      {isLoading ? (
        ...
        <Tabs defaultValue="scheduled" className="w-full">
          {/* TabsList Styling Updated to Match Provider View */}
            ...
            <TabsContent value="pending" className="space-y-4">
              {pendingAppointments.length > 0 ? (
                ...
                <EmptyState
                  ...
                  subMessage="Any new requests will appear here."
                  icon={Clock}
                />
              )}
            </TabsContent>
            ...
            <TabsContent value="history" className="space-y-4">
              {historyAppointments.length > 0 ? (
                ...
                <EmptyState
                  ...
                  subMessage="Completed or cancelled appointments appear here."
                  icon={User}
                />
              )}
            </TabsContent>
