      ...
      <div className="flex-1 pr-16">
        <div className="container mx-auto px-6 py-8">
          ...
          <div className="mb-8">
            ...
            <p className="text-text-muted">Manage your account preferences and configurations</p>
          </div>
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-text-muted">Get notified about appointment changes</p>
                          </div>
                        </div>
                        <Switch
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-text-muted">Get notified when patients send messages</p>
                          </div>
                        </div>
                        <Switch
                          id="email-messages"
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-text-muted">Reminders before upcoming appointments</p>
                          </div>
                        </div>
                        <Switch
                          id="email-reminders"
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-text-muted">Real-time appointment notifications</p>
                          </div>
                        </div>
                        <Switch
                          ...
                          onCheckedChange={(checked) => 
                            setNotifications({...notifications, pushAppointments: checked})
                          }
                        />
                      </div>
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-text-muted">Instant message notifications</p>
                          </div>
                        </div>
                        <Switch
                          id="push-messages"
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm text-text-muted">Who can see your profile information</p>
                      </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm text-text-muted">Let patients see when you're online</p>
                      </div>
                      <Switch
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm text-text-muted">Help improve our service with usage data</p>
                      </div>
                      <Switch
                  ...
                  <div className="p-6 bg-gradient-to-r from-blue-50 to-blue-100 rounded-lg">
                    <div className="flex justify-between items-center">
                      <div>
                        ...
                        <p className="text-text-muted">Unlimited patients, video calls, and features</p>
