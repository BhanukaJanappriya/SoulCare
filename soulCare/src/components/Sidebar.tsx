...
import { Calendar, Activity, BarChart3, Utensils, LogOut } from "lucide-react";
...
const Sidebar: React.FC = () => {
  return (
    <div className="bg-slate-700 text-white w-20 min-h-screen flex flex-col items-center py-6 space-y-6">
      ...
      <Calendar className="w-6 h-6 text-white cursor-pointer hover:text-blue-300" />
      <Activity className="w-6 h-6 text-white cursor-pointer hover:text-blue-300" />
