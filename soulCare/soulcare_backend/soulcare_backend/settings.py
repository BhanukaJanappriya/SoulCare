"""
Django settings for soulcare_backend project.
...
SECRET_KEY = 'django-insecure-h=(btuj(fnw3y&jawfg2_a(hbbyeav)3p_gvdyhin6xw98-!d('
...
STRIPE_PUBLISHABLE_KEY = os.getenv('***REMOVED***') 
STRIPE_SECRET_KEY =os.getenv ('***REMOVED***')
