...
class IsAuthorOrAdmin(permissions.BasePermission):
    ...
    or a user with admin/staff privileges.
    """
    def has_object_permission(self, request, view, obj):
        ...
        # Write permissions are only allowed if the user is a superuser/staff
        # or is the author of the post.
        return request.user.is_superuser or request.user.is_staff or obj.author == request.user
